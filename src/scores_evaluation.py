...
# Regions dimensions
region_1 = np.array([[41.0, -30.0], [41.0, 113.33], [-272, -30.0], [-272, 113.33]])
region_2 = np.array([[-272, -30.0], [-272, 113.33], [-585, -30.0], [-585, 113.33]])
region_3 = np.array([[41.0, 113.33], [41.0, 256.66], [-272, 113.33], [-272, 256.66]])
region_4 = np.array([[-272, 113.33], [-272, 256.66], [-585, 113.33], [-585, 256.66]])
region_5 = np.array([[41.0, 256.66], [41.0, 400], [-272, 256.66], [-272, 400]])
region_6 = np.array([[-272, 256.66], [-272, 400], [-585, 256.66], [-585, 400]])
