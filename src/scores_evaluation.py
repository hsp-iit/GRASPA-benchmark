...
# Regions dimensions
region_1 = np.array([[41.0, -30.0], [41.0, 123.33], [-272, -30.0], [-272, 123.33]])
region_2 = np.array([[-272, -30.0], [-272, 123.33], [-585, -30.0], [-585, 123.33]])
region_3 = np.array([[41.0, 123.33], [41.0, 246.66], [-272, 123.33], [-272, 246.66]])
region_4 = np.array([[-272, 123.33], [-272, 246.66], [-585, 123.33], [-585, 246.66]])
region_5 = np.array([[41.0, 246.66], [41.0, 400], [-272, 246.66], [-272, 400]])
region_6 = np.array([[-272, 246.66], [-272, 400], [-585, 246.66], [-585, 400]])
